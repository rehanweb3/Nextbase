...
export default function SqlEditorPage() {
    ...
    const [tabs, setTabs] = useState<Tab[]>([{
        id: "1", name: "Query 1", code: "SELECT * FROM information_schema.tables WHERE table_schema = 'public' LIMIT 20;",
        results: null, fields: [], logs: [], executionTime: "", error: null,
    }]);
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0 h-screen">
                ...
                <div className="h-10 border-b border-border bg-muted/5 flex items-center px-4 overflow-x-auto overflow-y-hidden scrollbar-modern shrink-0 gap-1 pt-1">
                    {tabs.map((tab) => (
